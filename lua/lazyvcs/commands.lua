...
function M.setup()
	...
	command("LazyVcsBlame", svn_ui.blame, { desc = "Toggle global lazyvcs inline SVN blame" })
	command("LazyVcsBlameSplit", svn_ui.blame_split, { desc = "Toggle lazyvcs SVN full-file blame split" })
	command("LazyVcsBlameClear", svn_ui.blame_clear, { desc = "Disable global lazyvcs inline SVN blame" })
